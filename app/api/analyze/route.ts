...
export async function POST(request: NextRequest) {
  ...
  // Reject if the user already has a "processing" document. Prevents the
  // user from spamming parallel analyses (each consumes a trial slot and
  // a model call). Tight race window between SELECT and INSERT is
  // acceptable for V1; the form lock + submittingRef guard close most of it.
